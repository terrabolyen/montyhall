...
#' @title
#'  Select the initial picked door for the game.
#' @description
#'  `select_door()` selects a value to represent which door is picked in the Monty Hall game
#' @details
#'  This function selects the door for the game by sampling from a set of 1-3
#' @param 
#'  no arguments are used for the function
#' @return 
...
#' @description
#'  This function represents the next step of the game, where the host opens one of the doors that has a goat behind it.
#' @details
#'  This step samples between the remaining doors depending on whether the initial pick is a goat or car.
#' @param 
#'  a.pick - the output from select_door(), a number between 1-3
#'  game - output from create_game(), a length 3 character vector that detail positions of goats and cars
#' @return 
...
#' @title
#'  Decide whether to switch doors or stay with the first pick
#' @description
...
#' @title
#'  Determine if the final choice the user picked is a goat or car door.
#' @description
